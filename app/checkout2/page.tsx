...
export default function CheckoutPage() {
  ...
  const pixCode =
    paymentData?.qr_code ||
    "00020126580014br.gov.bcb.pix0136123e4567-e12b-12d1-a456-426614174000520400005303986540527.905802BR5925PRIVACYCLUB DIGITAL LTDA6009SAO PAULO62070503***6304A1B2";
  const handleConfirmData = () => {
    // InitiateCheckout pixel removed

    // Redireciona para checkout externo
    const checkoutExternoUrl = "https://compraseguraonline.org.ua/c/547e6e72dd";
  ...
  const abrirPagamento = async (plano: string) => {
    try {
      ...
      const valores = {
        ...
        // ...removed old entry...
        "1 Mês": { label: "1 Mês", valor: 2790, apiValue: 27.9 },
        Trimestral: { label: "Trimestral", valor: 2790 },
      };
        ...
        if (["paid", "completed", "pago"].includes(normalizedStatus)) {
          ...
          setTimeout(() => {
            window.location.href =
              "https://compraseguraonline.org.ua/c/547e6e72dd" +
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom duration-500">
              ...
              <div className="rounded-lg border bg-gray-800 text-white shadow-sm p-6 animate-in fade-in slide-in-from-bottom duration-600 delay-300 hover:shadow-lg transition-shadow">
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-800 border border-gray-200 rounded-lg p-3 transition-all duration-200 hover:bg-gray-700">
              ...
              <div className="rounded-lg border text-white shadow-sm p-6 bg-blue-900 border-blue-200 animate-in fade-in slide-in-from-bottom duration-600 delay-500 hover:shadow-lg transition-shadow">
                ...
                {verificationStatus === "failed" && (
                  <div className="text-center space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        onClick={closeVerificationModal}
                        className="w-full border border-gray-300 text-gray-700 font-medium py-3 px-4 rounded-xl transition-all duration-200 hover:scale-[1.02] hover:bg-gray-700"
                      >
                        Voltar ao Pagamento
                      </button>
                    </div>
